...
public class ItemClient extends BaseClient {
    ...
    public ResponseEntity<Object> createItem(ItemRequestsDto itemRequestsDto, Long userId) {
    ...
    public ResponseEntity<Object> updateItem(Long userId, Long itemId, ItemRequestsDto itemRequestsDto) {
        return patch("/" + itemId, userId, itemRequestsDto);
    }

    public ResponseEntity<Object> createComment(Long itemId, Long userId, CommentRequestDto commentRequestDto) {
